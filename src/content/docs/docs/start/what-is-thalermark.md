...
- **Invoices.** Send a professional invoice from your phone in under a minute.
  Your customer gets an email with a link to view it and pay by card. You get
  told the moment it's paid.
- **Estimates.** Quote a job, and turn the quote into an invoice with one tap
  when you win it.
- **Expenses.** Snap a photo of a receipt. The AI reads it, fills in the
